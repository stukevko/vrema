...
export function OwnerWelcomeStrip({
  focusWeek,
  showPeaksModule = false,
}: {
  focusWeek?: number;
  showPeaksModule?: boolean;
}) {
      ...
      <ol className="mt-4 space-y-2 text-sm">
        ...
        {showPeaksModule ? (
          <li className="flex gap-3 rounded-xl border border-border/60 bg-background/50 px-3 py-2.5">
            ...
            <span>
              <strong className="text-foreground">Stoßzeiten (optional)</strong> — z. B. starke Tage für
              Plan-Hinweise markieren.
            </span>
          </li>
        ) : null}
      </ol>

  ...
  return (
    <button
      ...
      className={`flex items-center gap-2 px-4 py-2.5 rounded-2xl text-sm font-medium transition-all active:scale-95 border ${
        locked
          ? "bg-card backdrop-blur-xl border border-white/5 shadow-[0_8px_30px_rgb(0,0,0,0.12)] text-muted-foreground cursor-pointer md:hover:bg-card/70"
  ...
  return (
    <>
      <div className="max-w-6xl mx-auto space-y-5 md:space-y-6">
        ...
        {isManager && (
          <div className="rounded-2xl border border-white/5 bg-card px-4 py-3 text-xs text-white/80 shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
            ...
            {correctionRequests.length === 0 ? (
              ...
              correctionRequests.map((req) => (
                <div key={req.id} className="rounded-2xl border border-white/5 bg-card p-4 text-xs shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
                  ...
                  <p className="mt-1 text-white/80">Grund: {req.reason}</p>
          ...
          {logs.length === 0 ? (
            <div className="py-16 text-center">
              ...
              <a
                ...
                className="mt-4 inline-flex min-h-[44px] items-center rounded-2xl border border-border px-4 py-2 text-sm text-white/80 transition-all active:scale-95 md:hover:bg-card/70"
              >
                Erste Zeit erfassen
              </a>
            </div>
                  ...
                  {logs.map((log, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-5 py-4 tabular-nums text-white/80">
                          {log.clockOut
                        ...
                        <td className="px-5 py-4 tabular-nums font-bold text-white">
                          {dur !== null ? formatMins(dur) : "–"}
                        </td>
                        <td className="px-5 py-4">
                          <span
                          ...
                          <td className="px-5 py-4">
                            <div className="flex items-center gap-2">
                              <button
                                ...
                                disabled={isSaving}
                                className="rounded-xl border border-border px-2.5 py-1 text-[11px] text-white/80 md:hover:bg-card/70 transition-all active:scale-95 disabled:opacity-50"
                              >
                                Bearbeiten
                              </button>
                              {log.status === "ABSENT" && (
          ...
          <div className="w-full max-w-xl rounded-2xl border border-white/5 bg-card p-6 shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
            ...
            <div className="mt-4 flex items-center justify-end gap-2">
              <button
                ...
                className="rounded-xl border border-border px-3 py-2 text-xs text-white/80 md:hover:bg-card/70 transition-all active:scale-95"
              >
                Abbrechen
              </button>
              <button

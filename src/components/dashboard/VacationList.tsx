...
export function VacationList({ requests, canApprove }: VacationListProps) {
  ...
  if (requests.length === 0) {
    return (
      <div className="rounded-3xl bg-card border border-border shadow-[0_20px_50px_rgba(0,0,0,0.05)] backdrop-blur-xl p-8 text-center shadow-[0_20px_50px_rgba(0,0,0,0.05)]">
    ...
    <div className="space-y-3">
      {requests.map((req, i) => (
        <motion.div
          ...
          className="rounded-2xl bg-card border border-border shadow-[0_20px_50px_rgba(0,0,0,0.05)] backdrop-blur-xl p-6 shadow-[0_20px_50px_rgba(0,0,0,0.05)]"
        >

...
export function AIInsights() {
  ...
  return (
    <section className="relative rounded-3xl p-[1px] bg-gradient-to-r from-violet-300/40 via-sky-300/30 to-emerald-300/40">
      <div className="rounded-3xl bg-white border border-slate-100 p-6 shadow-[0_20px_50px_rgba(0,0,0,0.04)]">
        ...
        {loading ? (
          <div className="space-y-2">
            ...
            <div className="h-4 rounded-full bg-slate-100 animate-pulse w-11/12" />
            <div className="h-4 rounded-full bg-slate-100 animate-pulse w-10/12" />
          </div>
        ) : (

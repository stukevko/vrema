          ...
          return (
            ...
            >
              ...
              <div className="col-span-5 flex items-center gap-3 min-w-0">
                <div className="w-9 h-9 rounded-xl bg-card backdrop-blur-xl border border-border shadow-[0_20px_50px_rgba(0,0,0,0.04)] flex items-center justify-center text-sm font-bold text-foreground shrink-0">

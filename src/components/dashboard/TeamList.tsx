...
export function TeamList({
  ...
  if (members.length === 0) {
    return (
      <div className="rounded-2xl bg-card backdrop-blur-xl border border-border shadow-[0_20px_50px_rgba(0,0,0,0.05)] p-10 text-center">
  ...
  return (
    <div className="rounded-2xl bg-card backdrop-blur-xl border border-border shadow-[0_20px_50px_rgba(0,0,0,0.05)] overflow-hidden">
      {/* Header row */}
      <div className="grid grid-cols-12 gap-3 px-5 py-3 border-b border-border text-xs text-muted-foreground font-sans uppercase tracking-widest">
          ...
          return (
            ...
            >
              ...
              <div className="col-span-5 flex items-center gap-3 min-w-0">
                <div className="w-9 h-9 rounded-xl bg-card backdrop-blur-xl border border-border shadow-[0_20px_50px_rgba(0,0,0,0.05)] flex items-center justify-center text-sm font-bold text-foreground shrink-0">
              ...
              <div className="col-span-2 text-right">
                <span className="text-sm font-sans text-foreground">{member.weeklyHours}h</span>
              </div>

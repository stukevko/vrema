  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex">
      ...
      <div className="flex min-w-0 flex-1 flex-col bg-background md:min-h-screen">
        ...
        <main className="dashboard-touch-scroll native-app-tap flex-1 overflow-auto overscroll-y-contain px-2 pb-32 pt-[calc(4rem+env(safe-area-inset-top,0px))] touch-manipulation sm:px-3 md:px-8 md:pb-6 md:pt-0">
          {children}

  ...
  return (
    <section className="rounded-2xl border border-line bg-surface p-6 shadow-[var(--shadow-card)] dark:border-white/10 sm:p-8">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <p className="text-xs font-semibold uppercase tracking-widest text-muted-foreground">Urlaubsplan</p>
          <h2 className="mt-1 text-lg font-bold tracking-tight">Jahresplan {year}</h2>
          <p className="mt-1 text-sm text-muted-foreground">
            Wünsche eintragen, abgeben — Chef genehmigt und übernimmt in den Planer.
          </p>
        </div>
        {isManager ? (

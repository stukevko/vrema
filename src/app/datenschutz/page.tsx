  ...
  return (
    <main className="min-h-screen bg-background px-6 py-20 text-slate-900">
      <div className="mx-auto max-w-3xl space-y-8 rounded-2xl border border-border bg-card p-8">
        ...
        <section className="space-y-2 text-sm text-slate-700">
          <h2 className="font-semibold text-slate-900">2. Verarbeitete Daten und Zwecke</h2>
        ...
        <section className="space-y-2 text-sm text-slate-700">
          <h2 className="font-semibold text-slate-900">3. Rechtsgrundlagen</h2>
          <p>Art. 6 Abs. 1 lit. b DSGVO (Vertrag), lit. c (gesetzliche Pflichten), lit. f (berechtigtes Interesse).</p>
        </section>

        <section className="space-y-2 text-sm text-slate-700">
          <h2 className="font-semibold text-slate-900">4. Empfänger und Dienstleister</h2>
        ...
        <section className="space-y-2 text-sm text-slate-700">
          <h2 className="font-semibold text-slate-900">6. Cookies und technische Speicherung</h2>
          <p>
        ...
        <section className="space-y-2 text-sm text-slate-700">
          <h2 className="font-semibold text-slate-900">7. Deine Rechte</h2>

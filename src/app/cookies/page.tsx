    ...
    <main className="min-h-screen bg-background px-6 py-16 text-slate-900">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="space-y-5 rounded-2xl border border-border bg-card p-8 shadow-[0_20px_50px_rgba(0,0,0,0.04)]">
          ...
          <p className="text-sm text-slate-600">Übersicht zu technisch notwendigen Cookies bei Vrema.</p>

          <section className="rounded-xl border border-border bg-white p-4 text-sm text-slate-700">
            <h2 className="mb-2 font-semibold text-slate-900">Technisch notwendige Cookies</h2>
          <p>
          ...
          <section className="rounded-xl border border-border bg-white p-4 text-sm text-slate-700">
            <h2 className="mb-2 font-semibold text-slate-900">Keine Marketing-Cookies ohne Einwilligung</h2>
          <p>
          ...
          <section className="rounded-xl border border-border bg-white p-4 text-sm text-slate-700">
            <h2 className="mb-2 font-semibold text-slate-900">Browser-Einstellungen</h2>
          <p>

  ...
  return (
    <main className="min-h-screen bg-background px-6 py-20 text-foreground">
      <div className="mx-auto max-w-3xl space-y-6 rounded-2xl border border-border bg-card p-8">
        ...
        <p className="text-sm text-muted-foreground">Angaben gemäß Paragraph 5 DDG</p>

        <section className="space-y-1 text-sm text-foreground/90">
        ...
        <section className="space-y-1 text-sm text-foreground/75">
